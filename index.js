...
/////////////////
const BotName = 'ItsAboutScoopy'; 
const instagram = 'https://instagram.com/bayuajms'; 
const telegram = 'https://t.me/bloodydie'; 
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by bayuajms`)
})
